...
export class QuotesComponent implements OnInit {
  ...
  quotes: Quote[] = [
      ...
      new Quote(3, 'Milcah', 'Funny Science and Technology', 'If you cant explain it simply,you dont understand it well enough', 'Albert Einstein', new Date(2020,3,12)),
      new Quote(4, 'Lovine', 'Success and Technology....', 'The technology you use impresses no one.The experience you create with it is everything.', 'Sean Gerety', new Date(2019,6,18)),
      new Quote(5, 'Kelvin', 'Motivational Quotes', 'Success is a lousy teacher.It seduces smart people into thinking they cant lose.', 'Bill Gates', new Date(2020,2,17)),
  ]
  constructor() { }
